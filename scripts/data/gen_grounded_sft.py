...
# 코퍼스 밖(제1~39조 밖) 질문 — 진짜 거절 학습용
NEGATIVES = [
    "대통령의 임기는 몇 년인가?",              # 제70조 — 코퍼스 밖
    "국회의원의 정수는 몇 명 이상인가?",        # 제41조 — 코퍼스 밖
    "헌법개정은 어떤 절차로 이루어지는가?",     # 제128조~ — 코퍼스 밖
    "지방자치단체의 종류는 무엇으로 정하는가?",  # 제117조~ — 코퍼스 밖
    "대한민국의 경제질서는 무엇을 기본으로 하는가?",  # 제119조 — 코퍼스 밖
]
