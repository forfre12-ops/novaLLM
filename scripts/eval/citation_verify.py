...
def safe_print(text: str = "") -> None:
    """Windows cp949 콘솔에서도 데모 출력이 죽지 않게 출력 불가 문자를 치환."""
...
def verdict_mark(supported: bool) -> str:
    """콘솔 인코딩에 맞는 지지/실패 마커."""
    enc = sys.stdout.encoding or "utf-8"
    ...
    try:
        ...
        return "OK" if supported else "BAD"
    return mark
...
def main() -> int:
    ...
    if args.answer_file:
        ...
        safe_print(json.dumps(verify(ans, corpus), ensure_ascii=False, indent=2))
    return 0
